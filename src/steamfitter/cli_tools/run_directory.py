...
def get_last_stage_directory(
    ...
    ----------
    last_stage_version
        The path to the version. Can either be an absolute path, or a
        path relative to the last_stage_root
    last_stage_root
    ...
    last_stage_directory = (
        last_stage_root / last_stage_version
        if last_stage_root is not None
        else last_stage_version
    )
